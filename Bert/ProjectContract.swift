...
public class ProjectContract{
    ...
    // MARK: Init
    init(wallet:Wallet, contract: String){
...
//            ethContractAddress = EthereumAddress(contractAddressHash, ignoreChecksum: true)!
            ethContractAddress = EthereumAddress(contract, ignoreChecksum: true)!
